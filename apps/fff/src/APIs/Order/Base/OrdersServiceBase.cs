...
using Fff.APIs.Dtos;
using Fff.APIs.Errors;
using Fff.APIs.Extensions;
...
{
    protected readonly FffDbContext _context;

    public OrdersServiceBase(FffDbContext context)
    {
        _context = context;
    }
    ...
    /// <summary>
    /// Connect multiple Order Items records to Order
    /// </summary>
    ...
    /// <summary>
    /// Disconnect multiple Order Items records from Order
    /// </summary>
    ...
    /// <summary>
    /// Find multiple Order Items records for Order
    /// </summary>
    ...
    /// <summary>
    /// Update multiple Order Items records for Order
    /// </summary>
